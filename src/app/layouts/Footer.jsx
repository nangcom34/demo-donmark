...
const Footer = () => {
  return (
    <main>
      <section className="grid grid-cols-4 md:grid-cols-5 w-full rounded-t-3xl bg-[#404040] pt-6 px-4 duration-500">
        <aside className="col-span-4 sm:col-span-2 md:col-span-1 flex flex-col items-center justify-center">
          <Link
            href={"/"}
        ...
        <aside className="col-span-4 sm:col-span-2 md:col-span-1 flex flex-col items-center justify-center">
          ...
          >
            สินค้า{" "}
            <span className="text-red-400 text-xs md:text-sm lg:text-lg">
              ใหม่
            </span>
          </Link>
          <Link
        ...
        <aside className="col-span-4 sm:col-span-2 md:col-span-1 flex flex-col items-center justify-center">
          ...
          <Link
            href={"/"}
            className="mb-4 text-red-400 text-xs md:text-sm lg:text-lg"
          >
            ปัญหาที่พบ
          </Link>
        </aside>
          ...
          <article className="flex flex-col items-center justify-center">
            ...
            >
              <g clip-path="url(#clip0_267_1504)">
                <path
                  d="M20.3777 14.5552C18.8336 14.5552 17.3526 15.1686 16.2608 16.2605C15.1689 17.3523 14.5555 18.8332 14.5555 20.3774V43.6663H43.6666V14.5552H20.3777ZM36.3888 36.3885H21.8333V21.833H36.3888V36.3885Z"
                  fill="white"
                />
                <path
                  d="M14.5555 110.622C14.5555 112.166 15.1689 113.647 16.2608 114.739C17.3526 115.831 18.8336 116.445 20.3777 116.445H43.6666V87.3334H14.5555V110.622ZM21.8333 94.6112H36.3888V109.167H21.8333V94.6112Z"
                  fill="white"
                />
                <path
                  d="M87.3333 116.445H110.622C112.166 116.445 113.647 115.831 114.739 114.739C115.831 113.647 116.444 112.166 116.444 110.622V87.3334H87.3333V116.445ZM94.6111 94.6112H109.167V109.167H94.6111V94.6112Z"
                  fill="white"
                />
                <path
                  d="M110.622 14.5552H87.3333V43.6663H116.444V20.3774C116.444 18.8332 115.831 17.3523 114.739 16.2605C113.647 15.1686 112.166 14.5552 110.622 14.5552ZM109.167 36.3885H94.6111V21.833H109.167V36.3885Z"
                  fill="white"
                />
                <path
                  d="M72.7777 36.3891V29.1113H58.2222V43.6669H65.4999V36.3891H72.7777Z"
                  fill="white"
                />
                <path
                  d="M43.6666 43.6666H50.9444V50.9443H43.6666V43.6666Z"
                  fill="white"
                />
                <path
                  d="M50.9445 50.9448H65.5V58.2226H50.9445V50.9448Z"
                  fill="white"
                />
                <path
                  d="M72.7778 21.833V29.1107H80.0556V14.5552H50.9445V29.1107H58.2222V21.833H72.7778Z"
                  fill="white"
                />
                <path
                  d="M14.5555 50.9448H21.8333V65.5004H14.5555V50.9448Z"
                  fill="white"
                />
                <path
                  d="M43.6666 58.2226V65.5004H36.3888V50.9448H29.111V65.5004H21.8333V72.7782H14.5555V80.0559H29.111V72.7782H36.3888V80.0559H43.6666V72.7782H50.9444V58.2226H43.6666Z"
                  fill="white"
                />
                <path
                  d="M72.7778 58.222H80.0556V65.4998H87.3333V58.222H94.6111V50.9442H80.0556V36.3887H72.7778V43.6665H65.5V50.9442H72.7778V58.222Z"
                  fill="white"
                />
                <path
                  d="M65.5 109.166H50.9445V116.444H80.0556V109.166H72.7778V101.889H65.5V109.166Z"
                  fill="white"
                />
                <path
                  d="M80.0555 72.7777V65.4999H72.7777V58.2221H65.4999V65.4999H58.2222V72.7777H65.4999V80.0554H72.7777V72.7777H80.0555Z"
                  fill="white"
                />
                <path
                  d="M109.167 72.7779H116.444V80.0557H109.167V72.7779Z"
                  fill="white"
                />
                <path
                  d="M80.0555 72.7779H101.889V80.0557H80.0555V72.7779Z"
                  fill="white"
                />
                <path
                  d="M109.167 50.9448H101.889V58.2226H94.6111V65.5004H101.889V72.7782H109.167V65.5004H116.444V58.2226H109.167V50.9448Z"
                  fill="white"
                />
                <path
                  d="M72.7778 80.0552H80.0555V101.889H72.7778V80.0552Z"
                  fill="white"
                />
                <path
                  d="M50.9445 101.889H58.2222V94.6112H65.5V87.3334H58.2222V72.7779H50.9445V101.889Z"
                  fill="white"
                />
              </g>
              <defs>
        ...
        <aside className="col-span-4 md:col-span-5 flex items-center justify-center">
